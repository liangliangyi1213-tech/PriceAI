...
export function LiveTaobaoOffers({ offers, productName }: { offers: readonly LiveTaobaoProductOffer[]; productName: string }) {
  ...
  return <LivePlatformOffers
    ...
    listings={preparedOffers.map((offer) => listing(offer, productName))}
