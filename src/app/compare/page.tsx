  ...
  return (
    <>
      ...
      <main className="mx-auto min-h-screen max-w-6xl px-4 py-8 sm:py-12">
        ...
        <h1 className="mt-1 text-3xl font-bold tracking-tight text-slate-950">手机商品对比</h1>
        <p className="mt-2 text-slate-600">价格、评分、销量和性价比均来自当前目录的确定性数据。</p>
        ...
        {comparedProducts.length >= 2 ? (
          ...
          <section className="mt-8 rounded-2xl border border-dashed border-slate-300 p-8 text-center">
            ...
            <p className="mt-2 text-sm text-slate-600">可在搜索结果中加入 2 至 4 款手机，再开始对比。</p>
