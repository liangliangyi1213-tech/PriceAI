...
describe("live Pinduoduo service", () => {
  ...
  it("emits safe response and selection diagnostics for recommendation fallback", async () => {
    ...
    expect(events).toEqual([
      ...
      { event: "selection", source: "recommend", inputCount: 1, candidatePairCount: 1, uniqueAccessoryGoodsCount: 0, accessoryPairCount: 0, unrelatedPairCount: 0, accessoryKeywordPairCount: 0, nonRetailModelPairCount: 0, replacementPartPairCount: 0, modelMismatchPairCount: 0, suffixMismatchPairCount: 0, queryMismatchPairCount: 0, missingPhoneEvidencePairCount: 0, emptyQueryPairCount: 0, invalidPriceCount: 0, invalidIdentityCount: 0, eligibleCount: 1, deduplicatedCount: 1, selectedCount: 1, matchedProductCount: 1, matchedVariantCount: 0, variantStorageMismatchCount: 0, variantColorMismatchCount: 0, variantRegionMismatchCount: 0, variantConditionMismatchCount: 0, variantInsufficientEvidenceCount: 1, variantAmbiguousMatchCount: 0 },
    ]);
